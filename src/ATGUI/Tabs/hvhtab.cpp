...
{
	const char* yTypes[] = {
			"RANDOM_AA", "SIDEWAYSJITTER", "SLOW SPIN", "FAST SPIN", "RANDOM SPIN", "LBY SPIN", "JITTER", "RANDOM BACKJITTER", "BACKJITTER", "TURBO JITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "CASUALAA",// safe
	...
	const char* xTypes[] = {
			"UP", "DOWN", "DANCE", "FRONT", "FAKE PITCH", "LUA", // safe
